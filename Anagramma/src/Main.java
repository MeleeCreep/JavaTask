...
public class Main {
    public static void main(String[] args) {
        //Создайте программу, которая проверяет, является ли заданное слово анаграммой другого заданного слова. Результат выводится в консоль. Входные данные - два слова с произвольным количеством символов. Выходные данные - ответ на вопрос о том, является ли одно слово анаграммой другого. 
        while (true) {
            try {
