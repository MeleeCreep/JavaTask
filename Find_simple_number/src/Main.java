...
public class Main {
    public static void main(String[] args) {
        //Создайте программу, которая находит все простые числа в заданном диапазоне. Входные данные - два целочисленных значения – левая и правая границы диапазона.  
        //Выходные данные - список всех простых чисел, найденных в диапазоне. 
        //Требования к выводу – каждое найденное простое число на новой строке.
